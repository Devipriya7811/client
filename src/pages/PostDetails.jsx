    ...
    return(
        <div>
            ...
            {loader?<div className="h-[80vh] flex justify-center items-center w-full"><Loader/></div>:<div className="px-8 md:px-[200px] mt-8">
                ...
                <img src={IF+post.photo} alt="" className="w-50 h-25 mx-auto mt-8 rounded-lg"  />
                ...
                <div className="w-full flex flex-col mt-4 md:flex-row">
                    <input onChange={(e)=>setComment(e.target.value)} type="text" placeholder ="Write a Comment" className="md:w-[80%] outline-none px-3 py-2 mt-4 md:mt-0" />
