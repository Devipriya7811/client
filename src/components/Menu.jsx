...
const Menu = () => {
    ...
    return (
        <div className="bg-black w-[200px] z-10 flex flex-col items-start absolute top-15 right-8 md:right-30 mt-4 rounded-md p-4 space-y-4">
        ...
        {/* {user && <h3 className="text-white text-sm hover:text-gray-500 cursor-pointer"><Link to="/write"></Link>Write</h3>} */}
        {/* {user && <h3 className="text-white text-sm hover:text-gray-500 cursor-pointer"><Link to={"/my blogs/"+user._id}></Link>My blogs</h3>} */}
